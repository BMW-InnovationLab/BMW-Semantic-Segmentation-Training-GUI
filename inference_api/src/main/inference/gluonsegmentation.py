...
class InferenceEngine(AbstractInferenceEngine):
    ...
    def load(self):
        ...
        try:
            ...
            raise e
        self.nclasses=data["num_classes"]
        ...
        self.labels=data["classes_names"]
    ...
    def set_model_configuration(self, data):
        ...
        try:
            self.configuration['nclasses'] = data['num_classes']
        ...
        try:
            self.configuration['classesname'] = data['classes_names']
    ...
    def validate_json_configuration(self, data):
        try:
            if not isinstance(data['num_classes'], int):
        ...
        try:
            if not isinstance(data['classes_names'], list):
