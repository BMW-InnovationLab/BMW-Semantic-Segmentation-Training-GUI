...
from .resnetv1b import resnet18_v1b, resnet34_v1b, resnet50_v1s, resnet101_v1s, resnet152_v1s,resnet50_v1b,resnet101_v1b
...
def get_segmentation_model(model, pretrained_base_name='',classes=1000 , **kwargs):
    ...
    """modified block"""
    return models[model](pretrained_base_name=pretrained_base_name,classes=classes,**kwargs)

def get_backbone(name, pretrained_base_name='',classes=1000,**kwargs):
    models = {
        ...
        'resnet50v1b': resnet50_v1b,
        'resnet101v1b' : resnet101_v1b,
        'resnest50': resnest50,
    ...
    """modified block"""
    net = models[name](pretrained_base_name=pretrained_base_name,classes=classes,**kwargs)
    return net
"""modified Class block"""
class SegBaseModel(HybridBlock):
    ...
    def __init__(self, nclass, aux, backbone='resnet50', height=None, width=None,
                 base_size=520, crop_size=480, pretrained_base=True, pretrained_base_name='',classes=1000, **kwargs):
        super(SegBaseModel, self).__init__()
        self.aux = aux
        self.nclass = nclass
        with self.name_scope():
            pretrained = get_backbone(backbone, pretrained=pretrained_base, dilated=True,pretrained_base_name=pretrained_base_name,classes=classes, **kwargs)
