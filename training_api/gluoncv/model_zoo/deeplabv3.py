...
class DeepLabV3(SegBaseModel):
    ...
    def __init__(self, nclass, backbone='resnet50', aux=True, ctx=cpu(), pretrained_base=True,
                 height=None, width=None, base_size=520, crop_size=480, pretrained_base_name='',classes=1000,**kwargs):
        super(DeepLabV3, self).__init__(nclass, aux, backbone, ctx=ctx, base_size=base_size,
                                     crop_size=crop_size, pretrained_base=pretrained_base,pretrained_base_name=pretrained_base_name,classes=classes, **kwargs)
...
def get_deeplab(dataset='pascal_voc', backbone='resnet50', pretrained=False,
            root='~/.mxnet/models', ctx=cpu(0),pretrained_base_name='',classes=1000, **kwargs):
    r"""DeepLabV3
    Parameters
    ----------
    ...
    kwargs['root'] = root
    model = DeepLabV3(datasets[dataset].NUM_CLASS, backbone=backbone, ctx=ctx,pretrained_base_name=pretrained_base_name,classes=classes, **kwargs)
